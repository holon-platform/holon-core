 ...
 * 
 * <p>
 * {@link AsyncRestClientFactory} registration can be performed using default
 * Java extension through {@link ServiceLoader}, providing a
 * <code>com.holonplatform.async.http.AsyncRestClientFactory</code> file in
 * <code>META-INF/services</code> containing the AsyncRestClientFactory concrete
 * class names to register.
 * </p>
 * 
 * <p>
 * The {@link AsyncRestClientFactory} priority declaration is supported using
 * the {@link Priority} annotation on factory class (where less priority value
 * means higher priority order).
 * </p>
 * 
 * @since 5.2.0
 */
public interface AsyncRestClientFactory {
	...
	/**
	 * Get the {@link AsyncRestClient} implementation class returned by this
	 * factory.
	 * 
	 ...
	 * 
	 * @param classLoader The {@link ClassLoader} for which the instance creation is
	 *                    requested
