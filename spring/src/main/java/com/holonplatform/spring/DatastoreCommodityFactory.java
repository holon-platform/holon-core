...
/**
 * Annotation wich can be used on a {@link DatastoreCommodityFactory} type class to automatically register this factory
 * into a {@link Datastore} Spring bean.
 * 
 * <p>
...
@Inherited
@Component
public @interface DatastoreCommodityFactory {

	/**
	 * Get the optional {@link Datastore} bean name into which register the factory, if more than one Datastore bean is
