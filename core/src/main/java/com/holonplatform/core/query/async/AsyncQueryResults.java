...
/**
 * Asynchronous {@link QueryProjectionOperations} API, which uses {@link CompletableFuture} to provide the query
 * results.
 * 
 * @since 5.2.0
 */
@SuppressWarnings("rawtypes")
public interface AsyncQueryResults extends
		QueryProjectionOperations<CompletableFuture, CompletableFuture, CompletableFuture, CompletableFuture<Long>> {
	 ...
	 * @return A {@link CompletableFuture} of query results stream, an empty Stream if none
	 * @throws DataAccessException Error in query execution
	 */
	@Override
	<R> CompletableFuture<Stream<R>> stream(QueryProjection<R> projection);

	/**
	 * Convenience method to obtain the query results {@link #stream(QueryProjection)} as a {@link List}.
	 * @param <R> Results type
	 * @param projection Query projection (not null)
	 * @return A {@link CompletableFuture} of query results list, an empty List if none
	 * @throws DataAccessException Error in query execution
	 */
	@Override
	default <R> CompletableFuture<List<R>> list(QueryProjection<R> projection) {
	 ...
	 * @param <R> Result type
	 * @param projection Query projection (not null)
	 * @return A {@link CompletableFuture} of the Optional unique query result (an empty Optional if no results was
	 *         returned)
	 * @throws QueryNonUniqueResultException Only one result expected but more than one was found
	 * @throws DataAccessException Error in query execution
	 */
	@Override
	default <R> CompletableFuture<Optional<R>> findOne(QueryProjection<R> projection)
	 ...
	 * @return A {@link CompletableFuture} of the total results count
	 * @throws DataAccessException Error in query execution
	 */
	@Override
	default CompletableFuture<Long> countAll() {
	 ...
	 * @return A {@link CompletableFuture} of the query results {@link Stream} (an empty Stream if none)
	 * @throws DataAccessException Error in query execution
	 */
	@Override
	default <P extends Property> CompletableFuture<Stream<PropertyBox>> stream(Iterable<P> properties) {
	 ...
	 */
	@Override
	default <P extends Property> CompletableFuture<Optional<PropertyBox>> findOne(Iterable<P> properties)
			throws QueryNonUniqueResultException {
	 ...
	 * @param <P> Property type
	 * @param properties Property set to use as projection (not null)
	 * @return A {@link CompletableFuture} of the query results {@link List} (an empty List if none)
	 * @throws DataAccessException Error in query execution
	 */
	@Override
	default <P extends Property> CompletableFuture<List<PropertyBox>> list(Iterable<P> properties) {
	 ...
	 */
	@Override
	default CompletableFuture<Stream<PropertyBox>> stream(Property... properties) {
	 ...
	 */
	@Override
	default CompletableFuture<Optional<PropertyBox>> findOne(Property... properties)
			throws QueryNonUniqueResultException {
	 ...
	 */
	@Override
	default CompletableFuture<List<PropertyBox>> list(Property... properties) {
