...
/**
 * Asynchronous <em>insert</em> Datastore operation.
 *
 * @since 5.2.0
 * 
 ...
 */
public interface AsyncInsertOperation
		extends PropertyBoxOperation<AsyncInsertOperation, PropertyBoxOperationConfiguration>,
