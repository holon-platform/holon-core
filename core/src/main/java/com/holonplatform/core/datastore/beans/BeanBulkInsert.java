...
/**
 * Bean {@link BulkInsertOperation}.
 * 
 * @param <T> Bean class
 *
 * @since 5.1.0
 */
public interface BeanBulkInsert<T>
		extends BeanBulkInsertOperation<T, BeanBulkInsert<T>>, ExecutableOperation<BeanOperationResult<T>> {
