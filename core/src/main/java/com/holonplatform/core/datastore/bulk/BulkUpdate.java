...
/**
 * A {@link BulkOperation} expression to configure a bulk <code>UPDATE</code> operation and execute it using the
...
public interface BulkUpdate
		extends BulkUpdateOperation<BulkUpdate>, ExecutableOperation, Expression, DatastoreCommodity {
