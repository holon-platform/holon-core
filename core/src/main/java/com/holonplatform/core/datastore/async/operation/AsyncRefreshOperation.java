...
/**
 * Asynchronous <em>refresh</em> Datastore operation.
 *
 * @since 5.2.0
 * 
 * @see DatastoreOperations#refresh(com.holonplatform.core.datastore.DataTarget, PropertyBox)
 */
public interface AsyncRefreshOperation
		extends PropertyBoxOperation<AsyncRefreshOperation, PropertyBoxOperationConfiguration>,
		ExecutableOperation<CompletableFuture<PropertyBox>>, DatastoreCommodity {
