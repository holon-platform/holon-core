...
/**
 * Bean {@link BulkUpdateOperation}.
 * 
 * @param <T> Bean class
 *
 * @since 5.1.0
 */
public interface BeanBulkUpdate<T>
		extends BeanBulkUpdateOperation<T, BeanBulkUpdate<T>>, ExecutableOperation<BeanOperationResult<T>> {
