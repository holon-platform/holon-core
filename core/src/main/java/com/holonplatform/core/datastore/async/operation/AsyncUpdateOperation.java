...
/**
 * Asynchronous <em>update</em> Datastore operation.
 *
 * @since 5.2.0
 * 
 ...
 */
public interface AsyncUpdateOperation
		extends PropertyBoxOperation<AsyncUpdateOperation, PropertyBoxOperationConfiguration>,
