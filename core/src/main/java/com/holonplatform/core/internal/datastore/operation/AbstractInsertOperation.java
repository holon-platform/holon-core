...
/**
 * Abstract {@link InsertOperation}.
 *
 * @since 5.1.0
 */
public abstract class AbstractInsertOperation extends
		AbstractPropertyBoxOperation<InsertOperation, PropertyBoxOperationConfiguration, PropertyBoxOperationDefinition>
		implements InsertOperation {

	private static final long serialVersionUID = -4057061740077050931L;

	public AbstractInsertOperation() {
	 ...
	 */
	@Override
	protected InsertOperation getActualOperation() {
		return this;
	}
