...
/**
 * Filter which represents a "IS NOT IN a set of values" predicate.
 * 
 ...
 * @see QueryFilter
 */
public class NotInFilter<T> extends AbstractOperationQueryFilter<T> {

	private static final long serialVersionUID = 6510687277876288202L;
	 ...
	 */
	public NotInFilter(QueryExpression<T> left, QueryExpression<? super T> right) {
		super(left, FilterOperator.NOT_IN, right);
	}
