...
/**
 * Abstract {@link AsyncInsertOperation}.
 *
 * @since 5.2.0
 */
public abstract class AbstractAsyncInsertOperation extends
		AbstractPropertyBoxOperation<AsyncInsertOperation, PropertyBoxOperationConfiguration, PropertyBoxOperationDefinition>
		implements AsyncInsertOperation {

	private static final long serialVersionUID = -4057061740077050931L;

	public AbstractAsyncInsertOperation() {
	 ...
	 */
	@Override
	protected AsyncInsertOperation getActualOperation() {
		return this;
	}
