...
/**
 * Abstract {@link Insert}.
 *
 * @since 5.1.0
 */
public abstract class AbstractInsert extends AbstractExecutableDatastoreOperation<OperationResult, Insert>
		implements Insert {
	 ...
	 */
	@Override
	protected Insert getActualOperation() {
		return this;
	}
