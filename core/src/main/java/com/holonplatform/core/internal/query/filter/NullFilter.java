...
/**
 * Filter which represents "IS NULL" predicate.
 * 
 * @since 4.4.0
 * 
 * @see QueryFilter
...
public class NullFilter extends AbstractOperationQueryFilter {

	private static final long serialVersionUID = 4865001786185122051L;
	...
	public NullFilter(TypedExpression<?> expression) {
		super(expression, FilterOperator.NULL);
	}
