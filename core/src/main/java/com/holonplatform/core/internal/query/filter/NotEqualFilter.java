...
/**
 * Filter which represents a "IS NOT EQUAL" predicate.
 * 
 ...
 * @see QueryFilter
 */
public class NotEqualFilter<T> extends AbstractOperationQueryFilter<T> {

	private static final long serialVersionUID = -6134305790680964124L;
