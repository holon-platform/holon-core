 ...
 * @since 5.0.0
 */
public class UnsupportedPermissionException extends AuthorizationException {

	private static final long serialVersionUID = 4915993521633751782L;

	/**
	 * Constructor
	 * @param description Error description
	 */
	public UnsupportedPermissionException(String description) {
