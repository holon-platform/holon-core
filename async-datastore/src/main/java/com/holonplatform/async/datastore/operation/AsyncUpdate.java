...
/**
 * Asynchronous <em>update</em> {@link PropertyBoxOperation} operation, using {@link CompletionStage} to handle the
...
public interface AsyncUpdate
		extends ExecutablePropertyBoxOperation<CompletionStage<OperationResult>, AsyncUpdate> {
