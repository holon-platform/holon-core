...
/**
 * Asynchronous <em>insert</em> {@link PropertyBoxOperation} operation, using {@link CompletionStage} to handle the
 * operation result asynchronously.
 *
 * @since 5.2.0
 * 
 * @see DatastoreOperations#insert(com.holonplatform.core.datastore.DataTarget, PropertyBox,
 *      com.holonplatform.core.datastore.DatastoreOperations.WriteOption...)
 * @see AsyncDatastore
 */
public interface AsyncInsert
		extends ExecutablePropertyBoxOperation<CompletionStage<OperationResult>, AsyncInsert> {
