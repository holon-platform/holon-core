...
/**
 * Asynchronous <em>save</em> {@link PropertyBoxOperation} operation, using {@link CompletionStage} to handle the
 * operation result asynchronously.
 *
 * @since 5.2.0
 * 
 * @see DatastoreOperations#save(com.holonplatform.core.datastore.DataTarget, PropertyBox,
 *      com.holonplatform.core.datastore.DatastoreOperations.WriteOption...)
 * @see AsyncDatastore
 */
public interface AsyncSave
		extends ExecutablePropertyBoxOperation<CompletionStage<OperationResult>, AsyncSave> {
