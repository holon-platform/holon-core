...
/**
 * Asynchronous <em>delete</em> {@link PropertyBoxOperation} operation, using {@link CompletionStage} to handle the
 ...
 * @see AsyncDatastore
 */
public interface AsyncDelete extends ExecutablePropertyBoxOperation<CompletionStage<OperationResult>, AsyncDelete> {
