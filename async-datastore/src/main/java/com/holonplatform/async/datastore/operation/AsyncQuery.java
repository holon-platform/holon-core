...
/**
 * Represents an asynchronous <em>query</em>, used by the {@link AsyncDatastore} API to configure and execute a query
 * and handle the query results asynchronously through the {@link CompletionStage} type.
 * <p>
